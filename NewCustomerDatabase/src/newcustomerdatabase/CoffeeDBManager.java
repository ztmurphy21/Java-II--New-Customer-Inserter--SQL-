...
public class CoffeeDBManager
{
   ...
   */
   ...
   //creates new customer and adds it to customer
   
   //everything right here?
   public void createCustomer(String cNum, String  custName, String custAdd, String custCity, String custState, String custZip) throws SQLException{
      ...
      //sending execute update to customer table, this right
